...
class PostForm extends Component {
  ...
  toggleCancelDialog = () => {
    this.setState({ dialogCancelOpen: !this.state.dialogCancelOpen });
  };

  toggleSuccessDialog = () => {
    this.setState({ dialogSuccessOpen: !this.state.dialogSuccessOpen });
  };

  toggleErrorDialog = () => {
    this.setState({ dialogErrorOpen: !this.state.dialogErrorOpen });
  };
