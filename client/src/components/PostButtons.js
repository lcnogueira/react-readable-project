...
export const SubmitButton = props => {
  ...
  const successActions = [
    <FlatButton label="Ok" primary keyboardFocused onClick={onSuccess} />,
  ];
...
export const CancelButton = props => {
  ...
  const cancelActions = [
    <FlatButton label="Yes" primary keyboardFocused onClick={yesButton} />,
    <FlatButton label="No" primary keyboardFocused onClick={dialogClose} />,
  ];
